...
export const DOCS_CONFIG: DocSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Generators", href: "/docs/generators", description: "Lazy sequences with kaj* and utpadan" },
      { name: "EventEmitter", href: "/docs/eventemitter", description: "Event-driven architecture" },
      { name: "Worker Threads", href: "/docs/worker-threads", description: "Parallel processing with workers" },
      { name: "Streams API", href: "/docs/streams", description: "Efficient data processing with streams" },
      { name: "Buffer API", href: "/docs/buffer", description: "Binary data handling" },
      { name: "URL Parsing", href: "/docs/url-parsing", description: "Parse and manipulate URLs" },
      { name: "Collections", href: "/docs/collections", description: "Set and Map data structures" },
      { name: "Path Utilities", href: "/docs/path", description: "Cross-platform path manipulation" },
