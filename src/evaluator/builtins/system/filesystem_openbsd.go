...
// getFileOwnership extracts UID and GID from file info (OpenBSD-specific)
...
// getAccessTime extracts access time from file info (OpenBSD-specific)
...
// getCreationTime extracts creation time from file info (OpenBSD-specific)
...
// getFileInode extracts inode number from file info (OpenBSD-specific)
...
// getFileLinkCount extracts link count from file info (OpenBSD-specific)
